...
public class TestBatchCommand {
	...
	public static void main(String... strings) {
		...
		try {
			CommandCollapserGetValueForKey collapse1 = new CommandCollapserGetValueForKey(1);
			...
			System.out.println(" CommandKey Name : " + command.getCommandKey().name());
